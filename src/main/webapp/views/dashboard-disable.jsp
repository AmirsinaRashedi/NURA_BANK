                                ...
                                <div class="trans-info">
                                    <div class="container">
                                        <div class="warning">
                                            <p>
                            <span
                            >For security reasons, you have the option to
                              Disable your card temporarily. During the
                              period of deactivation, your card will be
                              unusable.</span
                            >
                                            </p>
                                            <p id="status">
