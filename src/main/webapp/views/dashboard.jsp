                ...
                <div class="column-middle">
                    <section>
                        <div class="transaction">
                            <div class="trans-container">
                                ...
                                <div class="trans-info">
                                    <div class="history">
                                        <div class="element">
                                            <p>
                            <span class="reason">variz</span
                            ><span class="flash"
                                            ><img src="../resources/files/pics/down.svg" alt=""
                                            /></span>
                                            </p>
                                            <p>
                            <span class="date">24/6/2022</span
                            ><span class="money"
                                            >3000 <span style="color: green">$</span></span
                                            >
                                            </p>
                                            <hr/>
                                        </div>
                                        <div class="element">
                                            <p>
                            <span class="reason">enteghal</span
                            ><span class="flash"
                                            ><img src="../resources/files/pics/up.svg" alt=""
                                            /></span>
                                            </p>
                                            <p>
                            <span class="date">24/6/2019</span
                            ><span class="money"
                                            >460 <span style="color: green">$</span></span
                                            >
                                            </p>
                                            <hr/>
                                        </div>
                            ...
                            <span class="date">24/6/2019</span
                            ><span class="money"
                                            >500 <span style="color: green">$</span></span
                                            >
                                            </p>
                                            <hr/>
                                        </div>
                            ...
                            ><span class="flash"
                                            ...
                                            <p>
                            <span class="date">12/9/2019</span
                            ><span class="money"
                                            >2400 <span style="color: green">$</span></span
                                            >
                                            </p>
                                            <hr/>
                                        </div>
                                        <div class="element">
                                            <p>
                            <span class="reason">daryaft</span
                            ><span class="flash"
                                            ><img src="../resources/files/pics/down.svg" alt=""
                                            /></span>
                                            </p>
                                            <p>
                            <span class="date">24/7/2019</span
                            ><span class="money"
                                            >1000 <span style="color: green">$</span></span
                                            >
                                            </p>
                                            <hr/>
                                        </div>
