                                ...
                                <div class="trans-info">
                                    <div class="container">
                                        <div class="warning">
                                            <p>
                            <span
                            >To shop online, you need a single-use online
                              password. When you press the button, you will
                              receive the password via SMS.
                            </span>
                                            </p>
                                        </div>
                                        <div class="online-password">
                                            <form action="" method="">
                                                <button id="online-pass-button" class="activation">Get Password</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
